...
const DataTable = () => {
  ...
  const columns = [
    ...
    {
      accessorKey: 'lastName',
      header: () => <span>Primer Apellido</span>
    },
    {
        accessorKey: 'lastName',
        header: () => <span>Segundo Apellidos</span>
    },
    {
      accessorKey: 'age',
...
{/** 
            ...
            {table.getHeaderGroups().map(headerGroup => (
              <tr key={headerGroup.id} className="border-b border-gray-300 text-gray-600 bg-gray-100" >
                {headerGroup.headers.map(header => (
                  <th key={header.id} className="py-2 px-2 text-left uppercase">
      ...
      */}
      <center><h1>Bienvenido al apartado de gestion de la Cruz Roja Todo movimiento debe hacerlo con responsabilidad</h1></center>
    </div>
  )
}
